...
5주간 자율주행 시스템의 핵심 기술들을 단계별로 학습한 내용을 정리한 TIL(Today I Learned)입니다. ROS 기초부터 시작하여 객체 탐지, 경로 계획 및 제어 시스템까지 체계적으로 학습한 내용을 담고 있습니다.
...
│  │   센서      │───▶│   인지      │───▶│   판단      │         │
│  │ (Camera,    │    │ (Object     │    │ (Path       │         │
│  │  LiDAR,     │    │ Detection,  │    │ Planning,   │         │
│  │  GPS/IMU)   │    │ Localization│    │ Decision    │         │
│  └─────────────┘    └─────────────┘    │ Making)     │         │
│                                        └─────────────┘         │
│                                               │                 │
│                                               ▼                 │
